...
{
    public class DateTouchActionItem : FileMetaDataActionItem
    {
        ...
        public DateTouchActionItem(FileInfo fileToTouch, ProcessedEpisode processedEpisode, DateTime date)
        {
        ...
        public DateTouchActionItem(DirectoryInfo directoryToTouch, TheTvDbSeason season, DateTime date)
        {
        ...
        public DateTouchActionItem(DirectoryInfo directoryToTouch, ProcessedSeries processedSeries, DateTime date)
        {
        ...
        {
            if (other is DateTouchActionItem realOther)
            {
        ...
        public override int CompareTo(object other)
        {
            ...
            if (other.GetType() != typeof(DateTouchActionItem))
            {
                return 1;
            }

            return CompareTo(other as DateTouchActionItem);
        }
