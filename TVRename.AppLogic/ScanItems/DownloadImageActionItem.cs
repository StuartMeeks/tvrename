...
{
    public class DownloadImageActionItem : DownloadActionItem
    {
        ...
        public DownloadImageActionItem(ProcessedSeries processedSeries, ProcessedEpisode processedEpisode, FileInfo destinationFile, string path, bool mede8erShrink = false)
        {
        ...
        {
            if (other is DownloadImageActionItem realOther)
            {
        ...
        public override int CompareTo(object other)
        {
            ...
            if (other.GetType() != typeof(DownloadImageActionItem))
            {
                return 1;
            }

            return CompareTo(other as DownloadImageActionItem);
        }
